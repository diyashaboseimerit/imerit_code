const { fetchModelProgress } = require('../models/progressModel');
 ...
 */
const fetchPController = async (request, h) => {
  ...
  return fetchModelProgress({ userid })
    .then((data) => {
...
module.exports = { fetchPController };